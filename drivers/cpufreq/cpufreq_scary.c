...
#define DEFAULT_SLEEP_MAX_FREQ 312000
#define DEFAULT_SLEEP_MIN_FREQ 156000
#define DEFAULT_SLEEP_PREV_FREQ 156000 //This is so that if there are any issues resulting in sleep_prev_freq getting set, there will be a backup freq
#define DEFAULT_PREV_MAX 624000
